...
## 场景描述
在源码跟踪[3]中, 我们看到了`ServletInvocableHandlerMethod`中的`invokeForRequest()`调用了我们自己写的controller中的方法, 它的返回值是一个`Object returnValue`, 现在我们就继续跟踪剩下的部分, 看看一个简单的GET请求返回的时候的处理流程.
